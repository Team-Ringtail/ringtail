...
def _build_timing_svg(summary: dict[str, Any]) -> str:
  ...
  <text x="{156 + baseline_width:.1f}" y="111" fill="#fecaca" font-size="14" font-family="Arial, sans-serif">{baseline_ms:.3f} ms</text>
  ...
  <text x="{156 + optimized_width:.1f}" y="169" fill="#bbf7d0" font-size="14" font-family="Arial, sans-serif">{optimized_ms:.3f} ms</text>
