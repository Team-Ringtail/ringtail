"""
Tests for Remove Invalid Parentheses. Load solution from BENCHMARK_SOLUTION or same-dir solution.py.
"""
import os
...
remove_invalid_parentheses = getattr(solution, 'remove_invalid_parentheses')

def test_example():
    out = remove_invalid_parentheses('()())()'); assert '()()()' in out and '(())()' in out
