"""
Tests for Pascal's Triangle. Load solution from BENCHMARK_SOLUTION or same-dir solution.py.
"""
import os
...
generate = getattr(solution, 'generate')

def test_example():
    assert generate(5)[-1] == [1,4,6,4,1]
