"""
Tests for Kth Smallest Element in a Sorted Matrix. Load solution from BENCHMARK_SOLUTION or same-dir solution.py.
"""
import os
...
kth_smallest = getattr(solution, 'kth_smallest')
