"""
Tests for Swap Nodes in Pairs. Load solution from BENCHMARK_SOLUTION or same-dir solution.py.
"""
import os
...
swap_pairs = getattr(solution, 'swap_pairs')

def test_example():
    h = solution.ListNode(1); h.next = solution.ListNode(2); h.next.next = solution.ListNode(3); r = swap_pairs(h); assert r.val == 2 and r.next.val == 1
