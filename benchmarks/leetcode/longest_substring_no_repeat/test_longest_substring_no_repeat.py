"""
Tests for Longest Substring Without Repeating Characters. Load solution from BENCHMARK_SOLUTION or same-dir solution.py.
"""
import os
...
length_of_longest_substring = getattr(solution, 'length_of_longest_substring')
