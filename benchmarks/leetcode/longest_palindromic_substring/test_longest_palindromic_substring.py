"""
Tests for Longest Palindromic Substring. Load solution from BENCHMARK_SOLUTION or same-dir solution.py.
"""
import os
...
longest_palindrome = getattr(solution, 'longest_palindrome')
