"""
Tests for Find Peak Element. Load solution from BENCHMARK_SOLUTION or same-dir solution.py.
"""
import os
...
find_peak_element = getattr(solution, 'find_peak_element')

def test_example():
    assert find_peak_element([1,2,3,1]) in (2, 3)
