    ...
    for raw_entry in repos:
        ...
        try:
            ...
            row = {
                ...
                "baseline_time_ms": result.get("summary_stats", {}).get("baseline_time_ms", 0.0),
                "optimized_time_ms": result.get("summary_stats", {}).get("optimized_time_ms", 0.0),
                "improvement_ratio": result.get("winner_result", {}).get("improvement_ratio", 0.0),
                "time_saved_pct": result.get("summary_stats", {}).get("time_saved_pct", 0.0),
                ...
                "timing_graph_path": result.get("artifacts", {}).get("timing_graph_path", ""),
                "summary_json_path": result.get("artifacts", {}).get("summary_json_path", ""),
                "error": "",
            }
